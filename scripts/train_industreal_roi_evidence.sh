...
export RUN_PREFIX="${RUN_PREFIX:-industreal_strict_causal_roi_temporal_s${SEED:-7}}"
...
export ANY_MISTAKE_WEIGHT="${ANY_MISTAKE_WEIGHT:-5.0}"
export MISTAKE_COMPONENT_WEIGHT="${MISTAKE_COMPONENT_WEIGHT:-0.25}"
export INCORRECT_HARD_NEGATIVE_RATIO="${INCORRECT_HARD_NEGATIVE_RATIO:-20.0}"
export COMPONENT_EVIDENCE_TEMPORAL_BLOCKS="${COMPONENT_EVIDENCE_TEMPORAL_BLOCKS:-2}"
